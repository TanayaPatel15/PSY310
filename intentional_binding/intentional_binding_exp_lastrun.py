...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\OneDrive\\Documents\\Psychopy_Experiments_Tutorials\\intentional_binding\\intentional_binding_exp_lastrun.py',
