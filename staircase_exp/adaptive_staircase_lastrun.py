...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\OneDrive\\Documents\\Psychopy_Experiments_Tutorials\\staircase_exp\\adaptive_staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        thisExp.addData('key_resp.correct', key_resp.corr)
        # check responses
