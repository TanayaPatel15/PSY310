...
expName = 'visual_search_task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\OneDrive\\Documents\\Psychopy_Experiments_Tutorials\\visual_search_experiment\\visual_search_task_lastrun.py',
