...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\OneDrive\\Documents\\Psychopy_Experiments_Tutorials\\motor_sequence_learning\\motor_sequence_learning_lastrun.py',
